...
- Do not ask for secrets, credentials, tokens, private keys, or unnecessary personal data during the interview.
...
- Only persist an intent document after explicit user confirmation, and only to the confirmed path.
